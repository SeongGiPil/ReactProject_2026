...
---
## 개발후기
일반 sns기능에 프로야구 팬들을 위한 기능이 많지는 않아 프로야구 팬으로서 안타까운점이 있었는데 이렇게 직접 구현을 해보니 부족한점도 많이 느꼈고 다양한 문제를 해결해 나감으로써 한단계 성장해 나가지않았나 생각한다.지속해서 이런 프로젝트를 시도해보며  어려움을 해결해나가고 배우며 개발자로 성장해 나가고싶다
